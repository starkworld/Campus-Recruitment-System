...
ResultSet rs=atmt.executeQuery("select * from placements where cname='"+t1+"'");
int count=0;
while(rs.next()){
	count=count+1;
}
...
PreparedStatement ptmt=con.prepareStatement("insert into placements values(?,?,?,?,?,?,?,?)");
ptmt.setString(1, t1);
ptmt.setString(2, t2);
ptmt.setString(3, t4);
ptmt.setString(4, t5);
...
ptmt.close();
	...
	out.print("<a href='tpohome.JSP'>Click here </a>To Go Back");
}
