        	...
        	<div id="templaetmo_left">
                ...
                <div class="templatemo_menu">
                	<ul>
						...
						<li id="tp1" onclick="functions(this)"><a href="#" target="_parent">Register TPO</a></li>
						<li id="st1" onclick="functions(this)"><a href="#">Register Student</a></li>	
						<li><a href="viewst.jsp">View Student List</a></li>	
						<li id="viewtpo" onclick="functions(this)"><a>View TPO List</a></li>
						<li><a href="deletest.html">Delete Student </a></li>
						<li><a href="update.jsp">Update Student </a></li>
...
<br><center>
             ...
             about
                    ...
                    <div id="viewtpo1" style="display: none;">
                
                	 <table border="1">
			 <tr><td>TPO Id:</td><td>TPO Name:</td><td>Designation</td><td>Experience</td><td>Emailid</td>
			 <td>Phone No</td><td>DOJ:</td><td>DOB:</td><td>Gender:</td></tr>
			 <%
			 Connection con=null;
			 try{
			 ...
			 ResultSet rs=st.executeQuery("select * from tpo");
