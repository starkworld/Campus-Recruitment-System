...
ResultSet rs=atmt.executeQuery("select * from TPO where id='"+t1+"'");
int count=0;
while(rs.next()){
	count=count+1;
}
...
PreparedStatement ptmt=con.prepareStatement("insert into TPO values(?,?,?,?,?,?,?,?,?,?,?)");
ptmt.setString(1, t1);
ptmt.setString(2, t2);
ptmt.setString(3, t3);
ptmt.setString(4, t4);
...
ptmt.setString(8, t8);
ptmt.setString(9, t9);
ptmt.setString(10, t10);
ptmt.setString(11, t11);
ptmt.execute();
ptmt.close();
}else{
